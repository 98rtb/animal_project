document.getElementById("getvoice1").onclick=function(){
...
function Timer4(){
    var synth= window.speechSynthesis;
    speak_data="If your background voice is only audible then every animal will dance together,click on the button below and try playing the sounds "
    var utter_this= new SpeechSynthesisUtterance(speak_data);
    synth.speak(utter_this);
